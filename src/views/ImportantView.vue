...
<template>
  <div>
    <Tasks :show-completed="showCompleted" :tasks="tasks" :my-tasks="myTasks" :sidebar-visible="sidebarVisible" :options="{ important: true }" @toggle-sidebar="emit('toggleSidebar')">
