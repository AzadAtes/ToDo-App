    ...
    <div v-if="props.tasks.length">
        ...
        <ul class="taskList" v-if="visible">
            <li class="taskListItem" v-for="task in props.tasks" :key="props.tasks">
                ...
                <div @click="task.important = !task.important">
                    <svg v-if="task.important" class="taskListItem" style="width:24px;height:24px;" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z" />
                    </svg>
                    <svg v-else class="taskListItem" style="width:24px;height:24px;" viewBox="0 0 24 24">
